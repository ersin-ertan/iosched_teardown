package ca.ersin.shared.data.prefs
...
class BooleanPreference(private val preferences: SharedPreferences, private val name: String,
...
class StringPreference(private val preferences: SharedPreferences, private val name: String,
